...
class AIService
{
    ...
    private const API_KEY = 'sk-proj-YOUR_KEY_HERE'; // Use Env::get for production
    // ────────────────────────────────────────────────────────────────────────
    ...
    {
        $apiKey = Env::get('OPENAI_API_KEY', self::API_KEY);
        if ($apiKey === 'sk-proj-YOUR_KEY_HERE' || empty($apiKey)) {
