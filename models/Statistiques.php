...
class Statistiques
{
    ...
    /** Top 5 most borrowed objects (all time) */
     ...
     * A loan is 'on time' if date_retour_effective <= date_retour_prevue (or no overdue).
     * A loan is 'late' if date_retour_effective > date_retour_prevue OR statut = 'en_retard'.
     */
