...
class Mission {
    ...
    private $equipe;
    private $estTerminee;
    private $meteo; // Format: "Temp|Condition|Icon"
    private $immatriculation_ambulance; // Champ de jointure

    public function __construct(
        $idMission = null, $idAmbulance = null, $dateDebut = null, $dateFin = null,
        $typeMission = null, $lieuDepart = null, $lieuArrivee = null, $equipe = null, $estTerminee = null, $meteo = null
    ) {
    ...
    public function getMeteo()                      { return $this->meteo; }
    ...
    public function setMeteo($meteo)                               { $this->meteo        = $meteo; }
