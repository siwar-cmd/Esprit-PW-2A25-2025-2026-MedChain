...
class LotMedicament
{
    ...
    public function getIsSensible() { return $this->is_sensible; }
    ...
    public function setIsSensible($is_sensible) { $this->is_sensible = $is_sensible; return $this; }
