        ...
        <div class="form-container">
            <form action="index.php?page=materiel&action=<?php echo isset($materielData) ? 'update&id=' . $materielData['idMateriel'] : 'store'; ?>" 
                ...
                <div class="form-group" id="group-nom">
                    ...
                    <?php if(isset($errors['nom'])): ?><p class="error-message" style="display:block;">⚠️ <?php echo htmlspecialchars($errors['nom']); ?></p><?php endif; ?>
                </div>
                ...
                <div class="form-group" id="group-categorie">
                    ...
                    <?php if(isset($errors['categorie'])): ?><p class="error-message" style="display:block;">⚠️ <?php echo htmlspecialchars($errors['categorie']); ?></p><?php endif; ?>
                </div>
                ...
                <div class="form-group" id="group-nombreUtilisationsMax">
                    ...
                    <div class="error-message" id="err-nombreUtilisationsMax">Veuillez entrer un nombre entier positif (≥ 1).</div>
                    <?php if(isset($errors['nombreUtilisationsMax'])): ?><p class="error-message" style="display:block;">⚠️ <?php echo htmlspecialchars($errors['nombreUtilisationsMax']); ?></p><?php endif; ?>
                </div>
                ...
                <div class="form-group" id="group-nombreUtilisationsActuelles">
                    ...
                    <div class="error-message" id="err-nombreUtilisationsActuelles">Veuillez entrer un nombre entier positif ou zéro.</div>
                    <?php if(isset($errors['nombreUtilisationsActuelles'])): ?><p class="error-message" style="display:block;">⚠️ <?php echo htmlspecialchars($errors['nombreUtilisationsActuelles']); ?></p><?php endif; ?>
                </div>
    ...
    <script>
        function validateForm(event) {
            ...
            if(!numRegex.test(max) || parseInt(max) < 1) {
                document.getElementById('group-nombreUtilisationsMax').classList.add('has-error');
                document.getElementById('err-nombreUtilisationsMax').style.display = 'block';
                isValid = false;
            }

            let act = document.getElementById('nombreUtilisationsActuelles').value.trim();
            if(act !== '' && (!numRegex.test(act) || parseInt(act) < 0)) {
                document.getElementById('group-nombreUtilisationsActuelles').classList.add('has-error');
                document.getElementById('err-nombreUtilisationsActuelles').style.display = 'block';
                isValid = false;
            }
