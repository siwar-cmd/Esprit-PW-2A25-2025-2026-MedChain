        ...
        <div class="form-container">
            <form action="index.php?page=ambulance&action=<?php echo isset($ambulance) ? 'update&id=' . $ambulance['idAmbulance'] : 'store'; ?>" 
                ...
                <div class="form-group" id="group-immatriculation">
                    ...
                    <?php if(isset($errors['immatriculation'])): ?><div class="error-message" style="display:block; color:#dc3545; font-size:12px; margin-top:5px; font-weight:500;">⚠️ <?php echo htmlspecialchars($errors['immatriculation']); ?></div><?php endif; ?><div class="error-message" id="err-immatriculation">Format invalide (Ex: lettres majuscules, chiffres et tirets, min 5).</div>
                ...
                <div class="form-group" id="group-modele">
                    ...
                    <?php if(isset($errors['modele'])): ?><div class="error-message" style="display:block; color:#dc3545; font-size:12px; margin-top:5px; font-weight:500;">⚠️ <?php echo htmlspecialchars($errors['modele']); ?></div><?php endif; ?><div class="error-message" id="err-modele">Le modèle doit contenir au moins 2 caractères.</div>
                </div>
                ...
                <div class="form-group" id="group-statut">
                    ...
                    <?php if(isset($errors['statut'])): ?><div class="error-message" style="display:block; color:#dc3545; font-size:12px; margin-top:5px; font-weight:500;">⚠️ <?php echo htmlspecialchars($errors['statut']); ?></div><?php endif; ?><div class="error-message" id="err-statut">Veuillez sélectionner un statut valide.</div>
                </div>
                ...
                <div class="form-group" id="group-capacite">
                    ...
                    <?php if(isset($errors['capacite'])): ?><div class="error-message" style="display:block; color:#dc3545; font-size:12px; margin-top:5px; font-weight:500;">⚠️ <?php echo htmlspecialchars($errors['capacite']); ?></div><?php endif; ?><div class="error-message" id="err-capacite">La capacité doit être un nombre entre 1 et 20.</div>
                </div>
