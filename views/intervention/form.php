        ...
        <div class="form-container">
            <form action="index.php?page=intervention&action=<?php echo isset($interventionData) ? 'update&id=' . $interventionData['idIntervention'] : 'store'; ?>" 
                ...
                <div class="form-group" id="group-typeIntervention">
                    ...
                    <?php if(isset($errors['typeIntervention'])): ?><p class="error-message" style="display:block;">⚠️ <?php echo htmlspecialchars($errors['typeIntervention']); ?></p><?php endif; ?>
                </div>
                ...
                <div class="form-group" id="group-niveauUrgence">
                    ...
                    <?php if(isset($errors['niveauUrgence'])): ?><p class="error-message" style="display:block;">⚠️ <?php echo htmlspecialchars($errors['niveauUrgence']); ?></p><?php endif; ?>
                </div>
                ...
                <div class="form-group" id="group-dateHeureFinPrevu">
                    ...
                    <?php if(isset($errors['dateHeureFinPrevu'])): ?><p class="error-message" style="display:block;">⚠️ <?php echo htmlspecialchars($errors['dateHeureFinPrevu']); ?></p><?php endif; ?>
                </div>
