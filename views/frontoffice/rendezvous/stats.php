...
// Stats by Status
$req = $pdo->prepare("SELECT statut, COUNT(*) as count FROM rendezvous WHERE idClient = ? GROUP BY statut");
$req->execute([$userId]);
$byStatus = $req->fetchAll(PDO::FETCH_ASSOC);

// Stats by Type
$req = $pdo->prepare("SELECT typeConsultation, COUNT(*) as count FROM rendezvous WHERE idClient = ? GROUP BY typeConsultation");
$req->execute([$userId]);
      ...
      <div class="stats-container">
        <div class="header">
          <div class="header-title">
            ...
            <h1>Statistiques de mes Rendez-Vous</h1>
          </div>
