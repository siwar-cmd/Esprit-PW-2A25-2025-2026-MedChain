        ...
        <div class="card">
            <form method="POST" action="">
                ...
                <div class="ai-assistant-card" style="background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 1px solid #bbf7d0; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 4px 15px rgba(34,197,94,0.1);">
                    ...
                    <p style="font-size: 13px; color: var(--green-dark); margin-bottom: 12px;">Décrivez rapidement le diagnostic ou les symptômes pour modifier et pré-remplir les champs ci-dessous.</p>
                    ...
                    <div id="ai-response-container" style="display:none; margin-top: 15px; background: white; padding: 15px; border-radius: 8px; border: 1px solid #bbf7d0;">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="applyAiSuggestions()" style="font-size: 13px; padding: 8px 12px; background: #e0f2fe; color: #0284c7; border: 1px solid #bae6fd;"><i class="bi bi-clipboard-check"></i> Remplacer les champs de la fiche</button>
                    </div>
                </div>
