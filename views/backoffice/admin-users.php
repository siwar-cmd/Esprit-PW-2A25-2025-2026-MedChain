        ...
        <div class="filter-form">
            <form method="GET" action="">
                <div class="filter-row">
                    ...
                    <div class="form-group"><label><i class="bi bi-person-badge"></i> Rôle</label><select name="role" class="form-control"><option value="">Tous</option><option value="user" <?= $role_filter === 'user' ? 'selected' : '' ?>>Utilisateur</option><option value="admin" <?= $role_filter === 'admin' ? 'selected' : '' ?>>Administrateur</option></select></div>
