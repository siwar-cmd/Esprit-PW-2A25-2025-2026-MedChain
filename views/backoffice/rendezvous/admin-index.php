    ...
    <main class="dashboard-main">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-content"><h3><?= $stats['total'] ?></h3><p>Total Rendez-vous</p></div>
            </div>
            <div class="stat-card">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table" id="rdvTable">
                    <thead>
                        <tr>
                            <th style="cursor:pointer" onclick="sortTable(0, 'rdvTable')">Date <i class="bi bi-arrow-down-up" style="font-size:10px;"></i></th>
                            <th style="cursor:pointer" onclick="sortTable(1, 'rdvTable')">Patient <i class="bi bi-arrow-down-up" style="font-size:10px;"></i></th>
                            <th style="cursor:pointer" onclick="sortTable(2, 'rdvTable')">Médecin <i class="bi bi-arrow-down-up" style="font-size:10px;"></i></th>
                            <th style="cursor:pointer" onclick="sortTable(3, 'rdvTable')">Type <i class="bi bi-arrow-down-up" style="font-size:10px;"></i></th>
