...
if (!empty($searchTerm)) {
    $searchData = $controller->searchMateriel($searchTerm);
...
<head>
    ...
    <title>Résultats de Recherche - Matériel</title>
    ...
    <style>
        ...
        .badge-hors_service { background: #fee2e2; color: #7f1d1d; }
    ...
    <div class="container-main">
        ...
        <?php if (empty($results)): ?>
            <div class="no-results">
                ...
                <p>Votre recherche n'a retourné aucun matériel.</p>
                <a href="materiel-index.php" style="color: var(--green); text-decoration: none; font-weight: 600;">
        ...
        <?php else: ?>
            ...
            <div class="result-card">
                <div class="result-title"><?= htmlspecialchars($item['nom']) ?></div>
                
                <div class="result-meta">
                    <div class="result-meta-item">
                        <strong>Catégorie</strong><br><?= htmlspecialchars($item['categorie'] ?? '-') ?>
                    </div>
                    <div class="result-meta-item">
                        <strong>Intervention</strong><br>
                        <?php if (!empty($item['id_intervention'])): ?>
                    ...
                    <div class="result-meta-item">
                        <strong>Disponibilité</strong><br><?= htmlspecialchars($item['disponibilite'] ?? '-') ?>
                    </div>
                    <div class="result-meta-item">
                        <strong>Utilisations actuelles</strong><br><?= htmlspecialchars($item['nombreUtilisationsActuelles'] ?? 0) ?>
                    </div>
                    <div class="result-meta-item">
                        <strong>Statut stérilisation</strong><br>
                        <span class="badge">
                            <?= htmlspecialchars($item['statutSterilisation'] ?? '-') ?>
                        </span>
                    </div>
                </div>
                ...
                <div class="btn-group-result">
                    <a href="materiel-view.php?id=<?= $item['idMateriel'] ?>" class="btn-small btn-view">
                        <i class="fas fa-eye"></i> Voir
                    </a>
                    <a href="materiel-edit.php?id=<?= $item['idMateriel'] ?>" class="btn-small btn-edit">
                        <i class="fas fa-edit"></i> Modifier
                    </a>
                    <?php if ($isAdmin): ?>
                    <button class="btn-small btn-delete" onclick="deleteMateriel(<?= $item['idMateriel'] ?>)">
