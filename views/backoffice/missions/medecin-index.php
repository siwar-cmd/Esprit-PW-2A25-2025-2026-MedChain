...
<title>Registre Missions – Espace Médecin – MedChain</title>
...
<div class="dashboard-container">
  <aside class="dashboard-sidebar">
    ...
    <nav class="dashboard-nav">
      ...
      <a href="../ambulances/medecin-index.php" class="dashboard-nav-item nav-sub"><i class="bi bi-truck-front-fill"></i> Ambulances</a>
      <a href="medecin-index.php" class="dashboard-nav-item active nav-sub"><i class="bi bi-geo-alt-fill"></i> Missions</a>
    ...
    <div class="card">
      ...
      <div class="card-body" style="padding:0;">
        ...
        <div style="overflow-x:auto;">
          <table class="table">
            <thead><tr><th>#</th><th>Type</th><th>Ambulance</th><th>Départ → Arrivée</th><th>Date début</th><th>Durée</th><th>Équipe</th><th>Statut</th></tr></thead>
            <tbody>
            ...
            <tr>
              ...
              <td><strong><?= htmlspecialchars($m['immatriculation']??'—') ?></strong><br><small style="color:var(--gray-500);"><?= htmlspecialchars($m['modele']??'') ?></small></td>
