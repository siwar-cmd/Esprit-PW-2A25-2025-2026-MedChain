...
<div class="card">
    <div class="card-header">
        <h1 class="card-title">Active Loans</h1>
        <div class="actions">
    ...
    <?php if (isset($_GET['success']) && $_GET['success'] === 'returned'): ?>
        <div class="alert alert-success">Loan returned successfully.</div>
    <?php endif; ?>
            ...
            <tbody>
                <?php foreach ($prets as $pret): ?>
                    <tr>
                        ...
                        <td>
                            <div class="actions">
                                <a href="<?php echo htmlspecialchars(routeUrl('pret', 'return', ['office' => 'back', 'id' => (int) $pret['id_pret']]), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-success" onclick="return confirm('Mark this loan as returned?');">Return</a>
                                <a href="<?php echo htmlspecialchars(routeUrl('pret', 'cancel', ['office' => 'back', 'id' => (int) $pret['id_pret']]), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-danger" onclick="return confirm('Cancel this active loan?');">Cancel</a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
