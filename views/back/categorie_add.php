...
<div class="card" style="max-width:640px;">
    <div class="card-header">
        <span class="card-title"><i class="bi bi-plus-circle-fill"></i> Ajouter une Catégorie</span>
    ...
    <form method="POST" id="catForm"
          action="<?php echo htmlspecialchars(routeUrl('categorie', 'add', ['office' => 'back']), ENT_QUOTES, 'UTF-8'); ?>">
        <div class="grid">
            <div class="form-group" style="grid-column:1/-1;">
                <label for="nom_categorie">Nom de la catégorie *</label>
                <input type="text" id="nom_categorie" name="nom_categorie"
                       value="<?php echo htmlspecialchars($_POST['nom_categorie'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                       placeholder="Ex: Jeux de société">
            ...
            <div class="form-group" style="grid-column:1/-1;">
                ...
                <div style="display:flex;gap:10px;align-items:center;">
                    <input type="text" id="icone" name="icone"
                           value="<?php echo htmlspecialchars($_POST['icone'] ?? 'bi-tag', ENT_QUOTES, 'UTF-8'); ?>"
                           placeholder="bi-tag" style="flex:1;">
                    <div id="iconPreview" style="width:40px;height:40px;border-radius:8px;background:rgba(29,158,117,.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <i class="bi <?php echo htmlspecialchars($_POST['icone'] ?? 'bi-tag', ENT_QUOTES, 'UTF-8'); ?>" style="font-size:20px;color:var(--green);"></i>
                    </div>
                </div>
            ...
            <div class="form-group" style="grid-column:1/-1;">
                ...
                <textarea id="description" name="description" rows="3"
                          placeholder="Description optionnelle..."><?php echo htmlspecialchars($_POST['description'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
        </div>
...
(function () {
    ...
    iconeInput.addEventListener('input', function () {
        ...
        iconPreview.innerHTML = '<i class="bi ' + val + '" style="font-size:20px;color:var(--green);"></i>';
    });
