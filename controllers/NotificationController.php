...
class NotificationController {
    ...
    private function sendEmail($to, $subject, $body) {
        // --- CONFIGURATION API ---
        $apiKey = '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'; // REMPLACEZ PAR VOTRE CLÉ API
        // -------------------------

        // Si la clé n'est pas configurée, on simule seulement
        if ($apiKey === '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') {
            return $this->simulateEmail($to, $subject, $body);
        }

        $data = [
            "sender" => ["name" => "MedChain", "email" => "walaaharbaoui@gmail.com"],
            "to" => [["email" => $to]],
            "subject" => $subject,
            "textContent" => $body
        ];
