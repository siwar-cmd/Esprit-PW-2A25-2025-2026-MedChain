...
<div class="dashboard-container">
    ...
    <aside class="dashboard-sidebar" id="sidebar">
        ...
        <nav class="dashboard-nav">
            ...
            <a href="profile.php" class="dashboard-nav-item active">
            ...
            <a href="../intervention-annulee/create.php" class="dashboard-nav-item">
            ...
            <a href="../../backoffice/intervention/medecin-index.php" class="dashboard-nav-item">
                <i class="bi bi-heart-pulse"></i> Interventions
            </a>
            <a href="../../backoffice/materiel/medecin-index.php" class="dashboard-nav-item">
