...
<?php if ($isLoggedIn): ?>
    ...
    <div class="user-menu">
        ...
        <div class="dropdown-menu-custom">
            ...
            <!-- NEW: Visible only for Admin and Médecin -->
            <?php if (in_array($userRole, ['admin', 'medecin'])): ?>
                <a href="view/backoffice/php/gestion_medicaments.php" target="_blank">
                    <i class="bi bi-capsule-pill"></i> Gestion des Médicaments Sensibles
                </a>
            <?php endif; ?>
