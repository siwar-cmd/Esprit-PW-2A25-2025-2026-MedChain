        ...
        <div class="card">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <textarea name="consignesAvantConsultation" class="form-control"><?= htmlspecialchars($fiche['consignesAvantConsultation'] ?? '') ?></textarea>
                </div>

                <div class="form-group">
                    <label>Pièces à apporter</label>
                    <textarea name="piecesAApporter" class="form-control"><?= htmlspecialchars($fiche['piecesAApporter'] ?? '') ?></textarea>
                </div>

                <div class="form-group">
                    <label>Tarif de consultation (TND)</label>
                    <input type="number" step="0.5" name="tarifConsultation" class="form-control" value="<?= htmlspecialchars($fiche['tarifConsultation'] ?? '0') ?>">
                </div>

                <div class="form-group">
                    <label>Mode de remboursement</label>
                    <input type="text" name="modeRemboursement" class="form-control" value="<?= htmlspecialchars($fiche['modeRemboursement'] ?? '') ?>">
                </div>

                <div class="checkbox-group">
                    <input type="checkbox" name="emailEnvoye" id="emailEnvoye" value="1" <?= $fiche['emailEnvoye'] ? 'checked' : '' ?>>
                    <label for="emailEnvoye" style="margin-bottom:0;">Envoyer par email au patient</label>
                </div>

                <div class="checkbox-group" style="margin-bottom: 20px;">
                    <input type="checkbox" name="calendrierAjoute" id="calendrierAjoute" value="1" <?= $fiche['calendrierAjoute'] ? 'checked' : '' ?>>
