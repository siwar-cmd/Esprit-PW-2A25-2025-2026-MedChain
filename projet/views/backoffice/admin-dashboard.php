...
<div class="dashboard-nav-title mt-4">Gestion Médicaments</div>

<?php if (in_array($_SESSION['user_role'], ['admin', 'medecin'])): ?>
    <a href="php/crud_lot.php" class="dashboard-nav-item <?= basename($_SERVER['PHP_SELF']) === 'crud_lot.php' ? 'active' : '' ?>">
        <i class="bi bi-box-seam"></i> Lots de Médicaments
    </a>
    <a href="php/crud_distribution.php" class="dashboard-nav-item <?= basename($_SERVER['PHP_SELF']) === 'crud_distribution.php' ? 'active' : '' ?>">
        <i class="bi bi-arrow-left-right"></i> Distributions
    </a>
        <a href="../frontoffice/php/lots.php" class="dashboard-nav-item">
        <i class="bi bi-capsule-pill"></i> Front Lots
    </a>

    <a href="../frontoffice/php/distributions.php" class="dashboard-nav-item">
        <i class="bi bi-heart-pulse"></i> Front Distributions
    </a>
<?php endif; ?>
...
<a href="../frontoffice/auth/profile.php" class="dashboard-nav-item">
    ...
    <main class="dashboard-main">
       ...
       <?php if (in_array($_SESSION['user_role'], ['admin', 'medecin'])): ?>
    <a href="php/crud_distribution.php" class="quick-action">
        <div class="quick-action-icon" style="background: #f59e0b;">
            <i class="bi bi-capsule-pill"></i>
        </div>
        <span>Gestion Médicaments</span>
    </a>
<?php endif; ?>
        </div>
