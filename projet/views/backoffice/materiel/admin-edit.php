...
if (!$data) { $_SESSION['error_message'] = 'Matériel non trouvé'; header('Location: admin-index.php'); exit; }
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}:root{--green:#1D9E75;--green-dark:#0F6E56;--navy:#1E3A52;--gray-500:#6B7280;--gray-200:#E5E7EB;--white:#fff;--radius-md:12px;--radius-xl:28px;--shadow-sm:0 1px 3px rgba(0,0,0,.08)}
        ...
        select.form-control{appearance:auto}.form-row{display:grid;grid-template-columns:1fr 1fr;gap:16px}
